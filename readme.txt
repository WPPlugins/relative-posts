...
Donate link: 
Tags: related posts, relative article, relative post, thumbnails, simple widget, lite widget, easy to use
Requires at least: 3.0.0
Tested up to: 3.3
Stable tag: 1.2.0
License: GPLv2 or later

With the Relative Posts plugin widget you can show up on the sidebar a list of related articles with or without thumbnails very easy.
== Description ==
...
1. Admin Panel
2. Post Page
3. Post Page With Thumbnail Images 
